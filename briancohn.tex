...
\vspace*{3mm}\section*{Areas of Expertise}


  \vspace*{2mm}
  \begin{tabularx}{17cm}{X}
  Theoretical (and applied) tendon-driven motor control, Application of VR/AR to a clinical exam-room environment, Strategic consulting for biotech artificial intelligence, Data analysis and visualization at scale.
  \end{tabularx}
  ...
  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    ...
    PI: Francisco J. Valero-Cuevas, Ph.D. \\
\end{tabularx}



    \vspace*{10mm}\section*{Experience}
  \noindent\begin{tabularx}{17cm}{X r}
...
\vspace*{4mm}\noindent\begin{tabularx}{17cm}{X r}
  Autonomous functional locomotion in a tendon-driven limb via limited experience & \textit{2018} \\ %may2015-may2018
...
\vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
  Quantifying and attenuating pathologic tremor in virtual reality & \textit{2018} \\ %may2015-may2018
...
\vspace*{3mm}\section*{Project Involvement}
  ...
  Collaborators: Sarah Ingersoll, Kenneth Hayashida, Francisco Valero-Cuevas


  \vspace*{3mm}
  \textbf{ReachVR} A VR-EEG-EMG-DBS assessment platform for children severely affected by Cerebral palsy --- Co-Investigator\\
  Collaborators: Sae Franklin (TUM Institute of Cognitive Systems), David Franklin (TUM Neuromuscular Diagnostics), Terence Sanger (Children's Hospital of Los Angeles), Francisco Valero-Cuevas
  ...
  \vspace*{3mm}
  \textbf{Kleo} Dextrous control of a bio-inspired tendon-driven robot --- Head of Transfer Learning Effort\\
  Collaborators: Ali Marjaninejad, Dar\'{i}o Urbina-Mel\'{e}ndez, Francisco Valero-Cuevas
...
%from August to December 2015
  ...
  \vspace*{2mm}\section*{Talks}

  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
  	Invited Presentation: USC Body Computing Conference, Los Angeles & Sep-2018\\ %Amplify
	  ...
	  South West Regional Meeting of Organismal Biologists SICB & Oct-2017 \\
    Podium Presentation: Alternative Muscle Club 5th Annual Meeting & Sep-2017 \\
    MedTechWorld-West Annual Conference, Anaheim & Feb-2017\\
    U. of Minnesota Computational Sensory-Motor Neuroscience (CoSMo)& Mar-2016 \\
...
\vspace*{2mm}\section*{Teaching}
  ...
  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    ...
    Role: Mentored over 30 teams, each of 2-8 undergraduate students and liased with project leads and industry partners  \\[2mm]
\end{tabularx}


  \vspace*{2mm}\section*{Workshops}
...
% % =======
% %     Society for Integrative and Comparative Biology & \multirow{3}{*}{}{Jan-2014} \\
% %     "Influence of Zooplanktivory on Retinal Ganglion Cell Topography in Labrid Reef Fishes" \\
% %     http://sicb.org/meetings/2014/schedule/abstractdetails.php?id=1100 \\[2mm]
% %   \end{tabularx}
...
% >>>>>>> 42aa05234f4d05648a819ec6b7819e5b5433ef62
...
%http://pitweb.pitzer.edu/communications/2017/04/18/pitzer-college-senior-three-alumni-named-2017-nsf-graduate-research-fellows/\
% https://withfoundation.org/voice-assist-for-all-team-amplify-wins-the-usc-cbc-with-foundation-hackathon/
