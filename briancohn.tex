...
\vspace*{3mm}\section*{Project Involvement}
  ...
  \vspace*{1mm}
  \begin{tabularx}{17cm}{X}
  \textbf{PD-Paradigm} A VR Experience that quantifies symptoms of Tremor in Parkinson's Disease --- Co-Investigator\\
  Collaborators: Sarah Ingersoll, Kenneth Hayashida, Francisco Valero-Cuevas


  \vspace*{3mm}
  \textbf{CP-Paradigm} A VR-EEG-EMG-DBS assessment platform for children with Cerebral palsy --- Co-Investigator\\
