...
\fancyhead{
  ...
  \begin{tabularx}{17cm}{X r}
    ...
    \url{https://briancohn.com/} & Menlo Park CA: (323) 455-4184 \\ 
    % \\ 
    \href{https://github.com/bc}{GitHub.com/bc} & \href{mailto:briancohn@kaspect.com}{briancohn@kaspect.com} \\& \href{mailto:brian.cohn@obviohealth.com}{brian.cohn@obviohealth.com}
  \end{tabularx}
}
\fancyfoot[C]{\thepage}
...
\vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
  \href{https://doi.org/10.1145/3485279.3485285}{"Enjoyable Physical Therapy Experience with Interactive Drawing Games in Immersive Virtual Reality"} & \textit{2021}\\
...
\newpage
  ...
  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    \textit{"Inter-rater variability of the Bristol Stool Scale on diapered stool"}\\[2mm]
    North American Society for Pediatric Gastroenterology, Hepatology and Nutrition, Dec-2021\\ %  Trieu, Melissa1; Jamshidbaigi, Nikki1; Punati, Jaya3; Danialifar, Tanaz3; Patel, Raza Ali2; Naon, Hillel3; Dallabrida, Susan1, 4; Cohn, Brian Alexander1
\textit{"Clinician Versus Caregiver Ratings of Pediatric Stool Consistency"}\\[2mm]
    DIA, Jun-2021\\ %Susan M Dallabrida1, Melissa K Trieu2, Nikki Jamshidbaigi2, Jamie Chen2, Pavle Medvidovic2, Austin Lamb2, Hillel Naon3, Raza A Patel4 , Jaya Punati3, Tanaz F Danialifar3, and Brian A Cohn2
\textit{"Automatic Image Segmentation to Preprocess Pediatric Stool Photos"}\\[2mm]
    DIA, Jun-2021\\ % Brian A Cohn1, Austin Lamb1, Pavle Medvidovic1, Jamie Chen1, Melissa K Trieu1, Nikki Jamshidbaigi1, Jaya Punati2, Hillel Naon2, Tanaz F Danialifar2, Raza A Patel3, and Susan M Dallabrida4
...
\vspace*{2mm}\section*{Peer-Reviewed Posters}
  ...
  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    DIA Global Annual Meeting 2021, "Automatic Image Segmentation to Preprocess Pediatric Stool Photos", Jul-2021\\
    DIA Global Annual Meeting 2021, "Clinician Versus Caregiver Ratings of Pediatric Stool Consistency", Jul-2021\\
...
% Failures:
% Adventure Biofeedback: Grant Submission Failed. 
  % "Development of a single software platform that provides real-time client feedback to enhance the success of speech teletherapy for children" 
  % COHN, BRIAN ALEXANDER (PD/PI) Impact Score: 48 ; Scientific Review Group: ZRG1 RPHB-J (12)  ' 07/13/2021; 1R43DC020059-01 GRANT13333876 
  % EUNICE KENNEDY SHRIVER NATIONAL INSTITUTE OF CHILD HEALTH & HUMAN DEVELOPMENT '
% ObvioHealth- CPI grant with CTIP- not picked:
  % StoolTool: Increasing sensitivity and reducing liability for in office pediatric stool interpretation
  % Dr. Brian Cohn1*, Dr. Jaya Punati2*, Dr. Tanaz F Danialifar2, Dr. Raza A Patel3, Dr. Hillel Naon2 and Dr. Susan Dallabrida4