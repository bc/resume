...
\vspace*{-15mm}\section*{Skills}
  ...
  \vspace*{1mm}\noindent\begin{minipage}{17cm}
    \begin{itemize}[leftmargin=6mm,topsep=0mm,itemsep=-1mm]
     ...
     \item Designed partnerships with USC and Pomona College to hire 18 internship fellows with funding or credit, and led teams in designing research-grade code.
  ...
  \vspace*{1mm}\begin{tabularx}{17cm}{X}
   ...
   In Press: Frontiers in Computational Neuroscience. Jul 2018 \\
	 Cohn BA, Szedlak M, Gartner B, Valero-Cuevas FJ \\[2mm]
