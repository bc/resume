...
%   \end{tabularx}
  ...
  \vspace*{1mm}\noindent\begin{minipage}{17cm}
    \begin{itemize}[leftmargin=6mm,topsep=0mm,itemsep=-1mm]
      ...
      \item Published resulting research at the IEEE Engineering in Medicine and Biology Society in Milan, and in Frontiers in Computational Neuroscience.
    \end{itemize}
  \end{minipage}
  ...
  \vspace*{1mm}\begin{tabularx}{17cm}{X}
   ...
   % \href{}{"Autonomous functional locomotion in a tendon-driven limb via limited experience."}\\
   % In submission: Science Robotics. Sep 2018 \\
   % Marjaninejad A, Urbina-Meléndez D, Cohn BA, Valero-Cuevas FJ\\[2mm]


   \href{}{"Feasibility Theory reconciles and informs alternative approaches to neuromuscular control"}\\
   Frontiers in Computational Neuroscience. Sep 2018 \\
	 \textbf{Cohn BA}, Szedlák M, Gärtner B, Valero-Cuevas FJ \\[2mm]
