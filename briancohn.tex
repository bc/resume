...
\fancyhead{
  ...
  \begin{tabularx}{17cm}{X r}
    ...
    \href{briancohn.com}{briancohn.com} & Los Angeles: (323) 455-4184 \\ 
    % \\ 
...
\vspace*{8mm}\section*{Professional Areas}
  ...
  Neuromechanics of vertebrates and robots (Ph.D. Thesis), Application of VR/AR to a clinical exam-room environment, Strategic consulting for biotech artificial intelligence to Fortune 10 companies, Data analysis and visualization at scale, design and fabrication of custom scientific equipment.
  \end{tabularx}
  ...
  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    \textbf{Masters Degree - Computer Science} & \textit{2018} \\ %may2015-may2018
    \textit{University of Southern California}
  \end{tabularx} 
  ...
  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    ...
    Co-PIs: \textbf{Brian A. Cohn, M.S.}, Dr. Kenneth Hayashida, M.D. \\
...
\end{tabularx}
  ...
  \vspace*{1mm}\noindent\begin{minipage}{17cm}
    \begin{itemize}[leftmargin=6mm,topsep=0mm,itemsep=-1mm]
      ...
      \item Culminated in a peer-reviewed full-length article accepted to IEEEVR 2020.
    \end{itemize}
  \end{minipage}

  \vspace*{2mm}\setlength\parindent{2mm}\begin{minipage}{16.8cm}
    \textit{Tools: Unity, C\#, R, Python, Bash, Hololens 2, and Vive Pro}
  \end{minipage}
%\vspace*{1.5mm}
  ...
  \vspace*{2mm}\setlength\parindent{2mm}\begin{minipage}{16.8cm}
    \textit{Tools: AWS mTurk, Scala, Python, R }
  \end{minipage}
...
\vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
   "The Self-Avatar Follower Effect in Virtual Reality" & \textit{2020}\\
    ...
    Gonzalez-Franco, M, \textbf{Cohn BA},Burin D, Ofek E, Maselli A \\[2mm]
\end{tabularx}
...
\vspace*{3mm}\section*{Project Involvement}
  ...
  \begin{tabularx}{17cm}{X}
  \textbf{Kaspect Reach} \\
  Undisclosed clinical study regarding artificial intelligence and health insurance.
...
% mirrors: https://parallelstate.com/news/a-robotic-leg-born-without-prior-knowledge-learns-to-walk/82548
% 
% 
% 
