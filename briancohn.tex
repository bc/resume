...
\vspace*{8mm}\section*{Professional Areas}
  ...
  Neuromechanics of vertebrates and robots, Application of AI,VR/AR to a clinical exam-room environment, Strategic consulting for biotech artificial intelligence to Fortune 10 companies, Data analysis and visualization at scale, design and fabrication of custom scientific signal-processing electronics.
  \end{tabularx}
  ...
  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    \textbf{Graduate Certificate - Health Technology and Engineering} & \textit{2019} \\ %may2015-may2019
    \textit{University of Southern California}
  \end{tabularx} 
  ...
  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    USC Viterbi School of Engineering: Mousetrap Grant  & \textit{2020-2021} \\
    Co-I's: Dr. Francisco Valero-Cuevas Ph.D., \textbf{Cohn} \\
    \vspace*{1mm}
    ...
    Co-PIs: \textbf{Cohn}, Dr. Christopher Laine, Ph.D. \\

    \vspace*{1mm}
    USC Marshall School of Business Incubator: Incubated Venture & \textit{2020} \\
    Co-PIs: \textbf{Cohn}, Dr. Kenneth Hayashida, M.D. \\

  % \noindent\begin{tabularx}{17cm}{X r}
  %   \textbf{USC Computer Science} & \textit{May 2015 - Present} \\
  %   \textit{Los Angeles, California} & \textbf{Ph.D. Student} \\
  % \end{tabularx}

  % \vspace*{1mm}\noindent\begin{minipage}{17cm}
  %   \begin{itemize}[leftmargin=6mm,topsep=0mm,itemsep=-1mm]
  %     \item Authored a Nature Machine Intelligence paper (cover article).
  ...
  %     \item Published a first-author paper with researchers from ETH-Z{\"u}rich, and published further research in IEEE EMBC in Milan, Italy.
  %     \item Mentored over 40 student-industry projects through the USC Capstone Program
  %   \end{itemize}
  % \end{minipage}
  
  % \vspace*{2mm}\setlength\parindent{2mm}\begin{minipage}{16.8cm}
  %   \textit{Tools: Scala, Spark, Python, R, HDFS, Amazon EC2, and MongoDB.}
  % \end{minipage}
...
\end{tabularx}
  ...
  \vspace*{1mm}\noindent\begin{minipage}{17cm}
    \begin{itemize}[leftmargin=6mm,topsep=0mm,itemsep=-1mm]
      ...
      \item Culminated in a peer-reviewed full-length \href{https://github.com/bc/resume/raw/master/papers/gonzalez-franco_et_al_ieeevr_2020.pdf}{article} in IEEEVR 2020.
    \end{itemize}
  \end{minipage}
...
%\vspace*{1.5mm}
  ...
  \vspace*{1mm}\noindent\begin{minipage}{17cm}
    \begin{itemize}[leftmargin=6mm,topsep=0mm,itemsep=-1mm]
      \item Identified significant flaws in a deployed model, and provided exceptional data-driven evidence for the new redesign.
      \item Single-handedly developed a crowd-sourced data-validation system, connecting tens of thousands of participants.
      \item Evaluated the statistical effectiveness of machine learning algorithms implemented.
    \end{itemize}
  \end{minipage}

  \vspace*{2mm}\setlength\parindent{2mm}\begin{minipage}{16.8cm}
    \textit{Tools: AWS mTurk/boto, Scala, Python, R }
  \end{minipage}
...
\vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
   "SnapMove: Movement Projection Mapping in Virtual Reality" & \textit{2020}\\
    (In review) Proceedings of IEEE AIVR \\
    % Microsoft Research, Redmond, Washington\\
   \textbf{Cohn B}, Maselli A, Ofek E, Gonzalez-Franco M\\[2mm]
\end{tabularx}
...
\vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
   ...
   "Simulating clinical confidence intervals for black-box algorithmic predictions of liver steatosis"} & \textit{2020}\\
    American Association for the Study of Liver Diseases (AASLD 2020) \\
...
\vspace*{3mm}\section*{Project Involvement}
  ...
  PI: Brian Cohn, Co-PI: Kenneth Hayashida, M.D.
  ...
  Active IRB: HS-12-00228, CCI-13-00324; BaCaTech Grant

  \vspace*{3mm}
  \textbf{Adventure Biofeedback} A choose-your-own-adventure style game to provide voice therapy treatment for Cerebral Palsy patients --- Co-Investigator \\
