% be sure tex is set up
%  then `sudo tlmgr update --self`
% then `sudo tlmgr install baskervald`
...
\pagebreak
    ...
    \textbf{Director of Research} & \textit{New York City, New York}  \\
  \end{tabularx}
  ...
  \vspace*{1mm}\noindent\begin{minipage}{17cm}
    \begin{itemize}[leftmargin=6mm,topsep=0mm,itemsep=-1mm]
      ...
      \item Hiring and managing a multidisciplinary research and technical team to implement new digital instruments for sponsored clinical trials.
  ...
  % \end{minipage}
    ...
    \textbf{Doctoral Research Intern} & \textit{Redmond, Washington}  \\
  \end{tabularx}
  ...
  \vspace*{3mm}\noindent\begin{tabularx}{17cm}{X r}
    ...
    \textbf{Consultant to} & \textit{Torrance, California}  \\
  \end{tabularx}
  ...
  \vspace*{3mm}\noindent\begin{tabularx}{17cm}{X r}
    ...
    \textbf{Consultant to} & \textit{Indianapolis, Indiana}  \\
  \end{tabularx}
...
\vspace*{6mm}\section*{Additional ongoing roles}

\noindent
\begin{tabularx}{17cm}{X r}
  Research Visiting Scientist, \textbf{Children's Hospital of Orange County} & \textit{2022 - Present} \\
\end{tabularx}

\noindent
\begin{tabularx}{17cm}{X r}
  Cofounder, \textbf{AdventureBiofeedback Inc.} & \textit{2017 - Present} \\
\end{tabularx}

\noindent
\begin{tabularx}{17cm}{X r}
  Founder \& Manager,  \textbf{Kaspect} & \textit{2015 - Present} \\
\end{tabularx}
...
% 
% \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
%   \href{<link for pdf>}{"VR paper with antonella and mar"} & \textit{2022}\\
%    Philosophical Transactions of the Royal Society B: Biological Sciences  \\
%    Antonella M, Mar Gonzalez-Franco, Eyal Ofek, TODO \textbf{Cohn BA}\\[2mm]
% \end{tabularx}
...
\newpage
  ...
  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    ...
    \textit{"Extracting muscle-to-force properties across arbitrary tendon-driven limbs"}\\
	  South West Regional Meeting of Organismal Biologists SICB, UC Irvine, CA & Oct-2017 \\[2mm] % in los angeles %  ; http://amcsd.ucsd.edu/2017/AMC2017_agenda.pdf
...
\vspace*{2mm}\section*{Peer-Reviewed Posters}
  ...
  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    ...
    North American Society for Pediatric Gastroenterology, Hepatology and Nutrition, & Dec-2021\\[2mm] %  Trieu, Melissa1; Jamshidbaigi, Nikki1; Punati, Jaya3; Danialifar, Tanaz3; Patel, Raza Ali2; Naon, Hillel3; Dallabrida, Susan1, 4; Cohn, Brian Alexander1
