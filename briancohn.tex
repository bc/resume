...
\vspace*{4mm}\noindent\begin{tabularx}{17cm}{X r}
  ...
  Marjaninejad A, Urbina-Mel\'{e}ndez D, Cohn BA, Valero-Cuevas FJ \\[2mm]
\end{tabularx} 
...
\vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
  ...
  Cohn BA, Shah DD, Marjaninejad A, Shapiro M, Ulkumen S, Laine CM, Valero-Cuevas FJ, Hayashida KH, Ingersoll S \\[2mm]
\end{tabularx}
...
\vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
   ...
   Frontiers in Computational Neuroscience \\
	 Cohn BA, Szedl\'{a}k M, G{\"a}rtner B, Valero-Cuevas FJ \\[2mm]
\end{tabularx}
